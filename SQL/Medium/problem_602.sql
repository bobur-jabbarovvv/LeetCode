...
the most friends number. The test cases are generated so that
...
Explanation: 
    ...
    so he has three friends in total,
    which is the most number than any others.
    Follow up: In the real world,
    multiple people could have the same most number of friends.
