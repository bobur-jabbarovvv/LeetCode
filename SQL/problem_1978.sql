...
whose manager left the company.When a manager leaves the company,
...
Explanation: 
    ...
    Joziah's manager is employee 6, who left the company because
    there is no row for employee 6 as it was deleted.
*/
