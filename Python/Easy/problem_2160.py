...
consisting of exactly four digits.
Split num into two new integers
...
Explanation:
    ...
    The minimum sum can be obtained by the pair [4, 9]:
    4 + 9 = 13.
"""
...
class Solution(object):
    def minimumSum(self, num):
        ...
        nums.sort()
        result = (nums[0] * 10 + nums[3]) + (nums[1] * 10 + nums[2])
