...
An integer divisible by the sum of its digits is
said to be a Harshad number. You are given an integer x.
...
Example 2:
    ...
    Output: -1
Explanation:
    The sum of digits of x is 5. 23 is not divisible by 5.
