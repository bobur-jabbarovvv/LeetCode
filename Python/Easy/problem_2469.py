...
rounded to two decimal places celsius,
that denotes the temperature in Celsius.
You should convert Celsius into Kelvin and
...
Explanation:
    Temperature at 36.50 Celsius converted in Kelvin is 309.65
...
Explanation:
    Temperature at 122.11 Celsius converted in Kelvin is 395.26
